document.addEventListener('DOMContentLoaded', () => {
  ...
  // Move the Logs to theLeft on Time Loop //
  ...
  // Move logs to the Right on a Time Loop //
  ...
  // Rules to Win Frogger Game //

  function win() {
    if (squares[4].classList.contains('frog')) {
      result.innerHTML = 'Winna Winna';
      squares[currentIndex].classList.remove('frog');
  ...
  // Move Frog when on the Log Left //
